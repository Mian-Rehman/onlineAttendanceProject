...
public class TeacherAttendanceSCR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_attendance_s_c_r);
        ...
        techAtt_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent=new Intent(TeacherAttendanceSCR.this,TeacherDashboard.class);
        ...
        if (ContextCompat.checkSelfPermission(TeacherAttendanceSCR.this, Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TeacherAttendanceSCR.this, new String[]{
